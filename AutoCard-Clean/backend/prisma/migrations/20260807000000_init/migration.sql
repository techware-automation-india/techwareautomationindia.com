node.exe : warn The configuration property 
`package.json#prisma` is deprecated and will be removed in 
Prisma 7. Please migrate to a Prisma config file (e.g., 
`prisma.config.ts`).
At C:\Users\DELL\OneDrive\Desktop\Techware projects\Techware-A
utomation-Portfolio\AutoCard-Clean\backend\node_modules\.bin\p
risma.ps1:24 char:5
+     & "node$exe"  "$basedir/../prisma/build/index.js" $args
+     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: (warn The config. 
   ..ma.config.ts`).:String) [], RemoteException
